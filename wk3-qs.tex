...
\begin{Exercise}
Find the determinant of the matrix \mks{4} \[\ma t+z & x+iy \\ x-iy
...
\end{Exercise}
\begin{Exercise}
Find the determinant of the following matrix by reducing to \mks{4}
...
\end{Exercise}
\begin{Exercise}
Find the inverse of the following matrices: \mks{4+8} \[\ma 4 & -25
